...
- GitHub の tree-commit-info API レスポンス形式変更に対応する &nbsp;-&nbsp; by **shota_ogasawara** and **Claude Sonnet 4.6 (1M context)** [<samp>(8e7a3)</samp>](https://github.com/d-kimuson/github-actions-search/commit/8e7a358)
- TypeScript の型エラーを修正する &nbsp;-&nbsp; by **shota_ogasawara** and **Claude Sonnet 4.6 (1M context)** [<samp>(108c8)</samp>](https://github.com/d-kimuson/github-actions-search/commit/108c806)
